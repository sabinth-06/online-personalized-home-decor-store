...
<nav class="sticky top-0 w-full z-50 bg-white/80 dark:bg-stone-950/80 backdrop-blur-md border-b border-stone-100 dark:border-stone-800 shadow-[0_10px_40px_-15px_rgba(6,78,59,0.04)]">
    <div class="flex justify-between items-center max-w-7xl mx-auto px-6 md:px-12 h-20">
        ...
        <div class="flex items-center gap-4">
            <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('admin-logout-form').submit();" class="px-4 py-2 rounded-full bg-rose-500/10 hover:bg-rose-500/20 text-rose-600 dark:text-rose-450 font-semibold text-xs transition-all flex items-center gap-1.5 border border-rose-500/20">
...
<div class="max-w-7xl mx-auto px-6 md:px-12 py-12 min-h-screen">
    ...
    @if (session('success'))
        <div class="bg-emerald-500/10 border border-emerald-500/20 text-emerald-800 dark:text-emerald-200 px-6 py-4 rounded-2xl mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 animate-fade-in">
            <div class="flex items-center gap-3">
                <span class="material-symbols-outlined text-emerald-700 dark:text-emerald-450 font-bold">check_circle</span>
    ...
    @if ($errors->any())
        <div class="bg-rose-500/10 border border-rose-500/20 text-rose-800 dark:text-rose-200 px-6 py-4 rounded-2xl mb-8 flex flex-col gap-1.5 animate-fade-in">
            <div class="flex items-center gap-3 font-bold text-sm">
                <span class="material-symbols-outlined text-rose-700 dark:text-rose-450">error</span>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
        ...
        <div class="bg-white/80 dark:bg-stone-950/80 backdrop-blur-md rounded-[2rem] p-6 whisper-shadow border border-stone-100 dark:border-stone-900 transition-all hover:-translate-y-1 hover:shadow-lg group">
            ...
            <div class="text-stone-500 text-[10px] mt-3 pt-2 border-t border-stone-100 dark:border-stone-900 flex flex-col gap-1">
                ...
                <div class="flex justify-between font-bold text-rose-600 dark:text-rose-450">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12 animate-fade-in">
        ...
        <div class="lg:col-span-1 bg-white/80 dark:bg-stone-950/80 backdrop-blur-md rounded-[2.5rem] p-8 border border-stone-100 dark:border-stone-900 whisper-shadow flex flex-col justify-between">
            ...
            <div class="space-y-2.5 pt-4 text-xs font-semibold">
                ...
                <div class="flex justify-between items-center">
                    <span class="text-emerald-700 dark:text-emerald-450 flex items-center gap-1.5"><span class="w-2.5 h-2.5 rounded bg-[#10b981]"></span> Standard Cart</span>
        ...
        <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-8">
            ...
            <div class="flex flex-col sm:flex-row gap-4 w-full lg:w-auto flex-1 justify-end">
                ...
                <div class="flex bg-stone-50 dark:bg-stone-900 p-1 rounded-2xl border border-stone-200/65 dark:border-stone-850 self-start">
                    <button onclick="filterUsersByRole('all', this)" class="role-filter-btn px-4 py-2 bg-white dark:bg-stone-950 text-stone-800 dark:text-stone-100 font-semibold rounded-xl text-xs shadow-sm transition-all">
                        All
                    </button>
                    ...
                    <button onclick="filterUsersByRole('user', this)" class="role-filter-btn px-4 py-2 text-stone-500 hover:text-stone-800 dark:hover:text-stone-200 font-semibold rounded-xl text-xs transition-all">
                        Users
                    </button>
                </div>
            </div>
                        ...
                        <tr class="order-row hover:bg-stone-50/40 dark:hover:bg-stone-900/20 transition-colors"
                            ...
                            <td class="px-6 py-5 whitespace-nowrap">
                                ...
                                <span class="block text-[10px] text-stone-400 font-semibold mt-1 flex items-center gap-1">
                                    <span class="material-symbols-outlined text-[12px] text-stone-450">calendar_today</span>
                            ...
                            <td class="px-6 py-5">
                                <div class="space-y-1">
                                    ...
                                    <details class="cursor-pointer group mt-1.5">
                                        <summary class="text-[10px] font-bold text-emerald-800 dark:text-emerald-450 select-none hover:underline flex items-center gap-0.5 list-none outline-none">
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="space-y-0.5">
                                            <div class="flex items-center gap-1.5">
                                                <span class="bg-amber-500/10 text-amber-800 dark:text-amber-450 px-2 py-0.5 rounded text-[8px] font-bold uppercase tracking-wider">Bespoke Custom</span>
                                            ...
                                            <div class="text-[10px] text-stone-450 font-semibold space-x-1.5 mt-1">
                                ...
                                @elseif($order->cart_items && is_array($order->cart_items))
                                    <div class="space-y-2 max-w-[280px]">
                                        <div class="flex items-center gap-1.5">
                                            ...
                                            <span class="text-stone-400 font-semibold text-[9px]">{{ count($order->cart_items) }} unit(s)</span>
                                        </div>
                            ...
                            <td class="px-6 py-5 whitespace-nowrap">
                                <span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/15 text-emerald-800 dark:text-emerald-450 font-bold text-[10px] uppercase tracking-wider mb-2">
...
<script>
    ...
    // Live Search & Client-Side Filtering logic for Users
    ...
    // Live Search & Client-Side Filtering logic for Orders
